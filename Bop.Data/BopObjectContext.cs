...
namespace Bop.Data
{
    ...
    /// </summary>
    public partial class BopObjectContext : DbContext, IDbContext
    {

        #region Ctor

        public BopObjectContext(DbContextOptions<BopObjectContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var typeConfigurations = Assembly.GetExecutingAssembly().GetTypes().Where(type => 
                ...
                && (type.BaseType.GetGenericTypeDefinition() == typeof(BopEntityTypeConfiguration<>) 
                    || type.BaseType.GetGenericTypeDefinition() == typeof(BopQueryTypeConfiguration<>)));
