...
using Bop.Data.Migrations;

namespace Bop.Data
{
    public class MySqlNopDataProvider : BaseDataProvider, IBopDataProvider
    {
        #region Fields
        ...
        protected void ExecuteSqlScriptFromFile(IBopFileProvider fileProvider, string filePath)
        {
        ...
        public void InitializeDatabase()
        {
            ...
            ExecuteSqlScriptFromFile(fileProvider, BopDataDefaults.MySQLStoredProceduresFilePath);
        }
        ...
        public virtual string BuildConnectionString(IBopConnectionStringInfo nopConnectionString)
        {
            if (nopConnectionString is null)
                throw new ArgumentNullException(nameof(nopConnectionString));

            if (nopConnectionString.IntegratedSecurity)
                throw new BopException("Data provider supports connection only with login and password");
