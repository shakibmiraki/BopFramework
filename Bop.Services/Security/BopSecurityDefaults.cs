...
namespace Bop.Services.Security
{
    ...
    public static partial class BopSecurityDefaults
    {
        ...
        /// </remarks>
        public static string PermissionsAllowedCacheKey => "Bop.permission.allowed-{0}-{1}";
        ...
        /// {0} : customer role ID
        /// </remarks>
        public static string PermissionsAllByCustomerRoleIdCacheKey => "Bop.permission.allbycustomerroleid-{0}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string PermissionsPatternCacheKey => "Bop.permission.";
