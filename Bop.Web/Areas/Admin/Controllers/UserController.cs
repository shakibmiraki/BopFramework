...
//        }
        ...
        public IActionResult RefreshToken([FromBody]JToken jsonBody)
        {
            ...
            var jwtToken = _tokenFactoryService.CreateJwtTokens(token.User);
            _tokenStoreService.AddUserToken(token.User, jwtToken.RefreshTokenSerial, jwtToken.AccessToken, _tokenFactoryService.GetRefreshTokenSerial(refreshTokenValue));
