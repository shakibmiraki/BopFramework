...
namespace Bop.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        private const string PHONE_EXPRESSION = @"^(09)[13][0-9]\d{7}$";
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new BopException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new BopException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new BopException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
