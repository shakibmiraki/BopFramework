...
namespace Bop.Core.Caching
{
    ...
    public partial class RedisCacheManager : IStaticCacheManager
    {
        ...
        private readonly BopConfig _config;
        ...
        protected virtual IEnumerable<RedisKey> GetKeys(EndPoint endPoint, string prefix = null)
        {
            ...
            keys = keys.Where(key => !key.ToString().Equals(BopDataProtectionDefaults.RedisDataProtectionKey,
        ...
        {
            //we should always persist the data protection key list
            if (key.Key.Equals(BopDataProtectionDefaults.RedisDataProtectionKey, StringComparison.OrdinalIgnoreCase))
                return;
