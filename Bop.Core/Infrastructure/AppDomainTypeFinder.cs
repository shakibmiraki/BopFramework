...
{
    /// <summary>
    /// A class that finds types needed by Bop by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IBopFileProvider _fileProvider;
        #endregion
        ...
        public AppDomainTypeFinder(IBopFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Bop.
        /// </returns>
        ...
        /// <summary>Gets or sets whether Bop should iterate assemblies in the app domain when loading Bop types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Bop assemblies aren't investigated (e.g. by not including something like "^Bop|..." you may break core functionality.</remarks>
